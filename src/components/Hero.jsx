    ...
    <section className="hero">
      <div className="container">
        <div className="hero-content">
          ...
          <div className="app-buttons">
            <a href="#" className="app-store-button">
              <img 
                src={isDarkMode ? "/src/assets/app-store/appstore-dark1.svg" : "/src/assets/app-store/appstore.svg"} 
                alt="Download on App Store" 
              />
            </a>
            <a href="#" className="google-play-button">
              <img 
                src={isDarkMode ? "/src/assets/app-store/googleplay-dark1.svg" : "/src/assets/app-store/googleplay.svg"} 
          ...
          <div className="discover-more">
            {isDarkMode ? (
              <button className="arrow-button arrow-button-dark">
        ...
        <div className="hero-image">
          <img 
            src="/src/assets/phones/Iphone2x.svg" 
